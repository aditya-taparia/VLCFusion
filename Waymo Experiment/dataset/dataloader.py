...
def collate_fn(list_data):
    ...
    for data_dict in list_data:
        ...
        batched_pts_path_list.append(pth_path)
    ...
    rt_data_dict = dict(
        ...
        batched_pts_path=batched_pts_path_list
    )

    return rt_data_dict


def get_dataloader(dataset, batch_size, num_workers, shuffle=True, drop_last=False, pin_memory=False, persistent_workers=False):
    collate = collate_fn
