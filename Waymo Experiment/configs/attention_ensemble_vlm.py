...
custom_imports = dict(
    imports=['configs.attention_ensemble_vlm.attention_ensemble_vlm'], allow_failed_imports=False)

model = dict(
    type='AttentionEnsembleVLM',
    ...
    train_jsonl_file='/home/local/ASURITE/ataparia/snap/snapd-desktop-integration/current/Desktop/mmdet3d/configs/attention_ensemble_vlm/vlm_conditions/night_day_training.jsonl',
    val_jsonl_file='/home/local/ASURITE/ataparia/snap/snapd-desktop-integration/current/Desktop/mmdet3d/configs/attention_ensemble_vlm/vlm_conditions/night_day_validation.jsonl',
    test_jsonl_file='/home/local/ASURITE/ataparia/snap/snapd-desktop-integration/current/Desktop/mmdet3d/configs/attention_ensemble_vlm/vlm_conditions/day_testing.jsonl',
    # test_jsonl_file='/home/local/ASURITE/ataparia/snap/snapd-desktop-integration/current/Desktop/mmdet3d/configs/attention_ensemble_vlm/vlm_conditions/night_day_testing.jsonl',
    backbone=dict(
        type='SECOND',
        in_channels=384,
