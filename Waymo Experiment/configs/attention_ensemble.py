...
custom_imports = dict(
    imports=['configs.attention_ensemble_vlm.attention_ensemble'], allow_failed_imports=False)

model = dict(
    type='AttentionEnsemble',
    ...
    test_jsonl_file='/home/local/ASURITE/ataparia/snap/snapd-desktop-integration/current/Desktop/mmdet3d/configs/attention_ensemble_vlm/vlm_conditions/dawn_dusk_testing.jsonl',
