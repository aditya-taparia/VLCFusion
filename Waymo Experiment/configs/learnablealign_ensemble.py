...
custom_imports = dict(
    imports=['configs.learnable_align.learnablealign_ensemble'], allow_failed_imports=False)

model = dict(
    type='LearnableAlignEnsemble',
    ...
    # test_jsonl_file='/home/local/ASURITE/ataparia/snap/snapd-desktop-integration/current/Desktop/mmdet3d/configs/cbam_ensemble/vlm_conditions/day_testing.jsonl',
    test_jsonl_file='/home/local/ASURITE/ataparia/snap/snapd-desktop-integration/current/Desktop/mmdet3d/configs/cbam_ensemble/vlm_conditions/dawn_dusk_testing.jsonl',
    # test_jsonl_file='/home/local/ASURITE/ataparia/snap/snapd-desktop-integration/current/Desktop/mmdet3d/configs/cbam_ensemble/vlm_conditions/night_day_testing.jsonl',
    backbone=dict(
        type='SECOND',
        in_channels=384,
