...
custom_imports = dict(
    imports=['configs.centerformer.centerformer'], allow_failed_imports=False)
...
val_evaluator = dict(
    type='WaymoMetric', waymo_bin_file='/home/local/ASURITE/ataparia/snap/snapd-desktop-integration/current/Desktop/mmdet3d/gt_validation.bin')
test_evaluator = dict(
    type='WaymoMetric',
...
default_hooks = dict(
    ...
    checkpoint=dict(type='CheckpointHook', interval=1)) # Changed interval after running (earlier it was 5)
