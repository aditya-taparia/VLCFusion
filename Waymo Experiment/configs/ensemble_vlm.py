...
custom_imports = dict(
    imports=['configs.custom_ensemble_vlm.ensemble_vlm'], allow_failed_imports=False)
...
model = dict(
    ...
    train_jsonl_file='/home/local/ASURITE/ataparia/snap/snapd-desktop-integration/current/Desktop/mmdet3d/configs/custom_ensemble_vlm/vlm_conditions/night_day_training.jsonl',
    val_jsonl_file='/home/local/ASURITE/ataparia/snap/snapd-desktop-integration/current/Desktop/mmdet3d/configs/custom_ensemble_vlm/vlm_conditions/night_day_validation.jsonl',
    test_jsonl_file='/home/local/ASURITE/ataparia/snap/snapd-desktop-integration/current/Desktop/mmdet3d/configs/custom_ensemble_vlm/vlm_conditions/dawn_dusk_testing.jsonl',
    # test_jsonl_file='/home/local/ASURITE/ataparia/snap/snapd-desktop-integration/current/Desktop/mmdet3d/configs/custom_ensemble_vlm/vlm_conditions/night_day_testing.jsonl',
    backbone=dict(
        type='SECOND',
        in_channels=384,
...
train_cfg = dict(type='EpochBasedTrainLoop', val_interval=1, max_epochs=20)
optim_wrapper = dict(
    type='OptimWrapper',
